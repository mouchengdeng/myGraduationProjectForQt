...
#include "../../SmartSparking/setserial.h"
...
QT_MOC_LITERAL(1, 10, 21), // "on_openButton_clicked"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 27), // "on_cancelPushButton_clicked"
QT_MOC_LITERAL(4, 61, 9) // "Read_Data"

    },
    "setSerial\0on_openButton_clicked\0\0"
    "on_cancelPushButton_clicked\0Read_Data"
};
...
void setSerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        setSerial *_t = static_cast<setSerial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject setSerial::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_setSerial.data,
      qt_meta_data_setSerial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *setSerial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_setSerial.stringdata0))
        return static_cast<void*>(const_cast< setSerial*>(this));
